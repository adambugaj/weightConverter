...
document.getElementById("inputValue").addEventListener("input", function(e){ 
    ...
    console.log(document.getElementById("option1").checked === true)
 ...
 document.getElementById("output").style.visibility = "visible";       
   ...
   document.getElementById("output").style.visibility = "visible";        document.getElementById("grams").innerHTML = '<h4 class="font-weight-light">Grams:</h4><div id="gramsOutput">'+(result / 0.001).toFixed(4)+'</div></div></div>';
...
document.getElementById("output").style.visibility = "visible";           document.getElementById("grams").innerHTML = '<h4 class="font-weight-light">Grams:</h4><div id="gramsOutput">'+(result / 0.035274).toFixed(3)+'</div></div></div>';
